...
export const OFFICE_VERSIONS: OfficeVersion[] = [
    ...
    },
    {
        ...
        title: 'Office 2013',
        products: [
            { id: 'ProPlusRetail', name: 'ProPlusRetail', includedApps: ['Access', 'Excel', 'OneNote', 'Outlook', 'PowerPoint', 'Word', 'Lync'], links: { online_x64: '#', online_x86: '#', offline: '#' } },
        ]
    },
    {
        id: 'office-2010',
        title: 'Office 2010',
        products: [
            { id: 'ProPlusRetail', name: 'ProPlusRetail', includedApps: ['Access', 'Excel', 'OneNote', 'Outlook', 'PowerPoint', 'Word', 'Publisher'], links: { online_x64: '#', online_x86: '#', offline: '#' } },
        ]
    }
];
