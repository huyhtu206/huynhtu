...
const generateWindowsFiles = (productSlug: string, version: string) => {
    let build = '22631.2428';
    let date = '2023-10-31';
    let size = '5.4 GB';

    // Win 11
    if (version.includes('25H2')) { build = '26200.5000'; date = '2025-04-01'; size = '6.1 GB'; }
    if (version.includes('24H2')) { build = '26100.1742'; date = '2024-10-01'; size = '5.8 GB'; }
    if (version.includes('23H2')) { build = '22631.2428'; date = '2023-10-31'; size = '5.4 GB'; }
    if (version.includes('22H2')) { build = '22621.1702'; date = '2022-09-20'; size = '5.2 GB'; }

    // Win 10
    if (productSlug.includes('win10')) {
        if (version.includes('22H2')) { build = '19045.3570'; date = '2022-10-18'; size = '5.7 GB'; }
        if (version.includes('21H2')) { build = '19044.1288'; date = '2021-11-16'; size = '5.5 GB'; }
    }

    // LTSC / LTSB
    if (version.includes('2024')) { build = '26100.1'; date = '2024-05-22'; size = '4.9 GB'; }
    if (version.includes('2021')) { build = '19044.1288'; date = '2021-11-16'; size = '4.5 GB'; }
    if (version.includes('2019')) { build = '17763.1'; date = '2018-11-13'; size = '4.2 GB'; }
    if (version.includes('2016')) { build = '14393.0'; date = '2016-10-12'; size = '3.8 GB'; }
    if (version.includes('2015')) { build = '10240.16384'; date = '2015-07-29'; size = '3.5 GB'; }

    // Server
    if (productSlug.includes('server')) {
        if (version.includes('2025')) { build = '26100.1742'; date = '2024-11-01'; size = '5.1 GB'; }
        if (version.includes('2022')) { build = '20348.169'; date = '2021-08-18'; size = '4.7 GB'; }
        if (version.includes('2019')) { build = '17763.1'; date = '2018-11-13'; size = '4.4 GB'; }
        if (version.includes('2016')) { build = '14393.0'; date = '2016-10-12'; size = '5.8 GB'; }
    }

    // Legacy
    if (version.includes('up3')) { build = '9600.17031'; date = '2014-11-20'; size = '4.0 GB'; }
    if (version.includes('sp1')) { build = '7601.17514'; date = '2011-02-22'; size = '3.1 GB'; }
    if (version.includes('sp2')) { build = '6002.18005'; date = '2009-04-28'; size = '3.5 GB'; }
    if (version.includes('pro') && productSlug === 'xp') { build = '2600.5512'; date = '2008-04-21'; size = '600 MB'; }

    return OFFICE_LANGUAGES.map(lang => ({
        language: lang.name,
        arch: 'x64' as const,
        sha256: `SHA256_${productSlug.toUpperCase()}_${version.toUpperCase()}_${lang.code.toUpperCase()}_${Math.random().toString(36).substring(7)}`,
        ...
        subcategories: [
            {
                ...
                items: [
                    ...
                    { id: 'win-11-consumer-24h2', name: 'Windows 11 Consumer 24H2', releases: [{ id: 'latest', title: 'Latest Release', files: generateWindowsFiles('win11_consumer', '24h2') }] },
                    { id: 'win-11-business-24h2', name: 'Windows 11 Business 24H2', releases: [{ id: 'latest', title: 'Latest Release', files: generateWindowsFiles('win11_business', '24h2') }] },
                    { id: 'win-11-consumer-23h2', name: 'Windows 11 Consumer 23H2', releases: [{ id: 'latest', title: 'Latest Release', files: generateWindowsFiles('win11_consumer', '23h2') }] },
                    { id: 'win-11-business-23h2', name: 'Windows 11 Business 23H2', releases: [{ id: 'latest', title: 'Latest Release', files: generateWindowsFiles('win11_business', '23h2') }] },
                    { id: 'win-11-consumer-22h2', name: 'Windows 11 Consumer 22H2', releases: [{ id: 'latest', title: 'Latest Release', files: generateWindowsFiles('win11_consumer', '22h2') }] },
                    { id: 'win-11-business-22h2', name: 'Windows 11 Business 22H2', releases: [{ id: 'latest', title: 'Latest Release', files: generateWindowsFiles('win11_business', '22h2') }] },
                    { id: 'win-11-ent-g', name: 'Windows 11 Enterprise G', releases: [{ id: 'latest', title: 'Latest Release', files: generateWindowsFiles('win11_ent_g', '24h2') }] },
                    { id: 'win-11-team', name: 'Windows 11 Team (Surface Hub)', releases: [{ id: 'latest', title: 'Latest Release', files: generateWindowsFiles('win11_team', '22h2') }] },
                    { id: 'win-11-insider-canary', name: 'Windows 11 Insider (Canary)', releases: [{ id: 'latest', title: 'Latest Release', files: generateWindowsFiles('win11_insider_canary', 'Insider') }] },
                    { id: 'win-11-insider-dev', name: 'Windows 11 Insider (Dev)', releases: [{ id: 'latest', title: 'Latest Release', files: generateWindowsFiles('win11_insider_dev', 'Insider') }] },
                    { id: 'win-11-insider-beta', name: 'Windows 11 Insider (Beta)', releases: [{ id: 'latest', title: 'Latest Release', files: generateWindowsFiles('win11_insider_beta', 'Insider') }] },
                ]
            }
        ]
    },
        ...
        subcategories: [
            {
                ...
                items: [
                    ...
                    { id: 'win-10-consumer-21h2', name: 'Windows 10 Consumer 21H2', releases: [{ id: 'latest', title: 'Latest Release', files: generateWindowsFiles('win10_consumer', '21h2') }] },
                    { id: 'win-10-business-21h2', name: 'Windows 10 Business 21H2', releases: [{ id: 'latest', title: 'Latest Release', files: generateWindowsFiles('win10_business', '21h2') }] },
                ]
            }
        ]
    },
